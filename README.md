...
:anger: Eu aprrendi a estrutura básica do CSS, incluindo a utilização de seletores, propriedades e valores;
 ...
 apliquei a propriedade de posicionamento fixo para criar elementos que permanecem fixos em uma determinada posição na página, independentemente do rolamento;
